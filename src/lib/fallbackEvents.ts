...
export const FALLBACK_EVENTS: Event[] = [
  ...
  },
  {
    ...
    description:
      "Explore the future of decentralized technology with industry experts and innovative projects.",
  ...
  },
  {
    ...
    description:
      "Learn to build iOS and Android apps from scratch in this intensive 3-day workshop.",
